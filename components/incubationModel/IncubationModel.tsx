    ...
    <div className="bg-[#F9F9F9] py-12 px-6">
      ...
      <div className="mt-14">
        <div className="text-start">
          <h3 className="text-3xl text-[#212121] mb-5 font-medium">
            Hypothesis
          </h3>
        ...
        <div className="text-start mt-14">
          ...
          <div className="flex gap-4 flex-wrap items-center justify-start font-normal mt-8">
            <span className="w-[226px] py-3 px-4 rounded-full bg-white text-sm text-center">
              Service Incubator Equity
            </span>
            <span className="w-[226px] py-3 px-4 rounded-full bg-white text-sm text-center">
              SEEQ Maths Equation
            </span>
            <span className="w-[236px] py-3 px-4 rounded-full bg-white text-sm text-center">
